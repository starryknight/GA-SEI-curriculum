...
## Instructions
  ...
  1. Create a project named `nostaldja_project` and an app named `nostaldja`.
  1. Set up (create a new) psql database.
  1. Do the Models and Migrations portions of the lab
  1. Then do URLs, Views, and Templates
...
Think about the URLs you will need for each resource (`Decade`s and `Fad`s). Hint: both resources will need at least 4 URLs, one for each CRUD action.
